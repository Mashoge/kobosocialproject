...
export const EvaluationReviewPage = (): JSX.Element => {
  ...
  const [activeTab, setActiveTab] = useState<"Overview" | "Client" | "Team">("Overview");
      ...
      <main className="flex-1 p-10 overflow-auto">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex border-b border-zinc-200">
            {["Overview", "Client Evaluation", "Team Evaluation"].map((tab) => {
          ...
          <div className="grid grid-cols-3 gap-6">
            ...
            <Card className="bg-white shadow-sm border-zinc-200">
              <CardContent className="p-6 flex justify-between items-center">
                ...
                <div className="text-right">
                  <p className="text-sm font-bold text-zinc-900">Pending Reviews</p>
                </div>
              </CardContent>
            </Card>
          </div>
            ...
            <div className="grid grid-cols-2 gap-0 border border-zinc-200 rounded-lg overflow-hidden bg-white">
              ...
              <div className="border-r border-zinc-200">
                ...
                <div className="divide-y divide-zinc-100 max-h-[500px] overflow-auto">
                  {filteredClientEvaluations.map((e) => (
                  ...
                  {filteredClientEvaluations.length === 0 && (
                    <div className="p-10 text-center text-zinc-400 italic text-sm">No client evaluations found</div>
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="divide-y divide-zinc-100 max-h-[500px] overflow-auto">
                  ...
                  {filteredTeamEvaluations.length === 0 && (
                    <div className="p-10 text-center text-zinc-400 italic text-sm">No team evaluations found</div>
                  )}
                </div>
              </div>
            </div>
